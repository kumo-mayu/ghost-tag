...
2. 「音声をテスト」で端末から音が出ることを確認する
3. 位置情報の利用を許可する
4. 必要ならパラメータを調整してSTART
5. GPS精度が閾値に届かない場合は、再取得するか表示精度を確認して開始する
6. 音の頻度で鬼との距離を判断しながら走って逃げる
7. 捕獲距離以下で鬼に追いつかれるとゲームオーバー
...
- GPS信号ロスト中とバックグラウンド中は、誤判定防止のため鬼の移動・捕獲判定・距離音を一時停止する。
